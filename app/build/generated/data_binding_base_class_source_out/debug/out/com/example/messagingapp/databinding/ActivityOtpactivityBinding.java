...
public final class ActivityOtpactivityBinding implements ViewBinding {
  ...
  private ActivityOtpactivityBinding(@NonNull ConstraintLayout rootView,
      @NonNull CardView cardView2, @NonNull Button continueBtn, @NonNull ImageView imageView,
      @NonNull OtpView otpView, @NonNull TextView phoneLbl, @NonNull TextView textView2,
  ...
  public static ActivityOtpactivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOtpactivityBinding((ConstraintLayout) rootView, cardView2, continueBtn,
          imageView, otpView, phoneLbl, textView2, textView3);
    }
